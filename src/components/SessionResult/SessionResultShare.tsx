    ...
    <Card className="flex-grow bg-yellow-50">
      <CardHeader>
        <div className="flex justify-between items-center">
          <CardTitle className="text-md">{'Join the action'}</CardTitle>
          <Share2 className="w-4 h-4 text-muted-foreground" />
        </div>
      </CardHeader>
      <CardContent>
        <h2 className="font-bold mb-2">{'Get the link to participate:'}</h2>
        ...
        <div className="flex items-center">
          ...
          <div className="flex mx-2 hover:cursor-pointer" onClick={toggleModal}>
            QR code
