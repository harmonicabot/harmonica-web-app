...
export default async function MultiSessionResults() {
  ...
  const sessionIds = [
    'aHN0XzU0ZTI3Y2Y4NzI0ZQ==', 'aHN0XzZlOTc5OTY5NGMwMA==', 'aHN0XzFkN2JmYzQxMDZmNg==',
    'aHN0X2ViYzM0MjlmOWE0Nw==', 'aHN0X2FjZTllNWRiNDMyNg==', 'aHN0X2RiMjI4NzQzN2M1YQ=='];
      ...
      <div className="p-4 md:p-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg p-8 mb-8">
          ...
          <p className="text-xl mb-4">
            Join us for an engaging discussion on artificial intelligence and its impact on French society
          </p>
          <div className="flex items-center gap-2 text-blue-100">
            ...
            <span>Paris University, in collaboration with Mission Publique</span>
          </div>
        </div>
